...
url: "/kultur/"
hero:
  image: /assets/images/banners/kultur-t1-hero.webp
  alt: "Tre abstrakte menneskesilhuetter i et nordisk skoglandskap — én kneler og studerer et tres røtter (kultur som dype røtter), én står med hånden på trestammen (verdier og normer), én ser opp gjennom trekronene (visjon og hensikt)"

  title: "Organisasjonskultur"
  intro: "Kultur er ikke noe du har — det er noe du gjør. Lær hvordan du forstår og påvirker kulturen i din organisasjon, fra Scheins tre nivåer til Logans fem stadier."
tags: ["organisasjonskultur", "kulturanalyse", "kulturutvikling", "endringsledelse"]
json_ld:
  - type: "Article"
    name: "Organisasjonskultur"
    description: "Hvordan forstå og påvirke organisasjonskultur. Fra Scheins kulturnivåer til Logans kulturstadier og Kotters endringsmodell."
    author:
      type: "Organization"
      name: "No Excuse AS"
    citation:
...
Les mer om [hvordan Scheins modell brukes i kulturanalyse →](/usikkerhet/)
...
Les mer om [hvordan tillit og psykologisk trygghet henger sammen →](/tillit/)
