...
layout: page
title: "Personvern for «Utforsk med din egen KI»"
...
Denne siden forklarer i enkelt språk hva som skjer når du bruker «Utforsk med din egen KI»-funksjonen på noexcuse.no. Den juridiske personvernerklæringen finner du på [/personvern/](/personvern/).

## 1. Hva knappen gjør

Når du klikker på et emne under «Utforsk med din egen KI», skjer følgende:

1. Vi bygger en prompt (en oppgavebeskrivelse) som inneholder:
   - Emnet du valgte (f.eks. «Uklare beslutningsroller»)
   - Et åpent spørsmål knyttet til emnet
