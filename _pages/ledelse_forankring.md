...
<section class="frame-section animate-on-scroll fade-in-up">
    ...
    <ul class="frame-questions stagger-parent" style="--stagger-delay: 80ms;">
        ...
        <li class="animate-on-scroll slide-in-left stagger">Har vi noen som bevisst utfordrer premissene våre?</li>
        <li class="animate-on-scroll slide-in-left stagger">Når ble siste gang en beslutning omgjort på grunn av nye facts?</li>
    </ul>
</section>
