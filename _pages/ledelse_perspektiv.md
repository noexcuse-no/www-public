...
<section class="section container--wide animate-on-scroll fade-in-up">
    ...
    <ul class="question-list stagger-parent" style="--stagger-delay: 80ms;">
        ...
        <li class="animate-on-scroll slide-in-left stagger">Hva ville ditt største problem sett ut som gjennom linsen du bruker minst?</li>
        <li class="animate-on-scroll slide-in-left stagger">Hvilket rammeverk mangler i ledergruppens naturlige samtale — og hva koster det dere å ikke ha det med?</li>
    </ul>
</section>
