...
json_ld:
  - type: "Article"
    name: "Håndtering av usikkerhet i ledelse"
    description: "Hvordan måle det som virker umålelig — og hvorfor usikkerhet er en mulighet for bedre ledelse. Forskning på risiko, kultur, endring og måling."
    author:
      type: "Organization"
      name: "No Excuse AS"
    citation:
...
![Diagram av Logans fem kulturstadier som en stige fra apati til felles suksess](/assets/images/banners/usikkerhet-t2-logan-stages.webp)
...
![Diagram av Kotters åtte steg for endringsledelse i en sekvensiell flyt](/assets/images/banners/usikkerhet-t2-kotter-steps.webp)
