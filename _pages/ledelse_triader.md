...
<section class="section container--wide animate-on-scroll fade-in-up">
    ...
    <ul class="question-list stagger-parent" style="--stagger-delay: 80ms;">
        ...
        <li class="animate-on-scroll slide-in-left stagger">Hvilken informasjon er fanget i par-relasjoner og når aldri frem til dem som trenger den?</li>
        <li class="animate-on-scroll slide-in-left stagger">Når introduserte du sist to personer for hverandre og trakk deg tilbake?</li>
    </ul>
</section>
