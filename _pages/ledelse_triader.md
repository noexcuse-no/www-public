...
json_ld:
  - type: "Article"
    name: "Triader — Bygg robuste team med trekantede relasjoner"
    description: "Hvorfor trekantede relasjoner er sterkere enn to-og-to. Fra dyader til triader — strukturelle verktøy for resilient organisasjon."
    author:
      type: "Organization"
      name: "No Excuse AS"
    citation:
...
questions:
  ...
  - "@context": "https://schema.org"
    ...
    mainEntity:
      - "@type": "Question"
        name: "Hva er en triade i organisasjonssammenheng?"
        acceptedAnswer:
          "@type": "Answer"
          text: "En triade er tre personer med gjensidige, ikke-eksklusive relasjoner. I motsetning til en dyade (to-person-relasjon) har triaden redundans: hvis én person faller ut, holder de to gjenværende forbindelsen i live."
      - "@type": "Question"
        name: "Hvorfor er triader sterkere enn dyader?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Triader er mer robuste fordi informasjon flyter i tre baner, konflikt kan trianguleres fremfor å bli personlig, og relasjonen overlever utskifting av enkeltpersoner. Dyader brytes når én person forsvinner; triader reduseres til en dyade og kan repareres."
      - "@type": "Question"
        name: "Hva må til for at triader skal dannes?"
        acceptedAnswer:
          "@type": "Answer"
...
Dave Logan, John King og Halee Fischer-Wright forsket i over et tiår på hva som kjennetegner høytytende organisasjonskulturer. Deres konklusjon, publisert i <em>Tribal Leadership</em> (2011), peker på triader — tre-person-relasjoner — som den kritiske byggesteinen i kulturer som presterer over tid.
...
![Abstrakt sammenligning av dyade og triade som relasjonsstrukturer](/assets/images/banners/triader-t2-dyad-vs-triad.webp)
...
*   ### 1. Felles verdier eller formål
    ...
    Dette er hvorfor det [symbolske perspektivet](/perspektiv/) er viktig: kultur, verdier og felles mening er limet som gjør triader holdbare. Bolman og Deal kaller dette det symbolske rammeverket — organisasjoner som kulturer båret av felles fortellinger og ritualer.
...
Det er verdt å merke seg at disse betingelsene speiler spenningen mellom [makt og tjeneste](/makt/) som vi har skrevet om tidligere. Viljen til å dele nettverket forutsetter et tjenende perspektiv på ledelse — at din rolle er å bygge broer, ikke å kontrollere hvem som snakker med hvem.
...
*   ### Maktkonsentrasjon — én som nekter å dele
    ...
    Logans tredje betingelse er den som oftest brytes. Én person i triaden nekter å dele nettverket sitt og holder de to andre adskilt. Resultatet er en «hub and spoke»-struktur der den ene eier all informasjon og alle relasjoner. Dette er maktdynamikk i praksis — les mer i vår artikkel om [makt og tjeneste i ledergruppen](/makt/).
