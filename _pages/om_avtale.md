...
§1.3 Avtalen gjelder til Oppdraget er fullført, men kan skriftlig sies opp av Kunden med 30 dagers varsel. NO EXCUSE AS kan kreve erstattet dokumenterte inntektstap som skyldes oppsigelsen. Påvises ikke noe inntektstap, skal Kunden betale et gebyr på 4% av den økonomiske rammen for avtalen.

§1.4 NO EXCUSE AS kan, dersom Kunden endrer Oppdragets innhold eller omfang vesentlig, si opp avtalen med tre måneders varsel med plikt til å fullføre påbegynt arbeid.
{% endcapture %}
{% include avtale-section.html heading="§1 Endring og erstatning" illustration="/assets/images/banners/avtale-t4-paragraf-1.webp" body=s1 %}
...
{% endcapture %}
{% include avtale-section.html heading="§2 Fakturering og reise" illustration="/assets/images/banners/avtale-t4-paragraf-2.webp" body=s2 %}
...
§3.2 NO EXCUSE AS kan ikke uten Kundens skriftlige samtykke utlevere konkrete arbeidsresultat til tredjemann.

§3.3 NO EXCUSE AS har rett til å vederlagsfritt anvende anonymiserte data fra bistanden og arbeidsresultatet til forskning i tråd med generelle og fagspesifikke forskningsetiske retningslinjer som bestemt av De nasjonale forskningsetiske komiteene.

§3.4 Alle materielle og immaterielle rettigheter til verktøy, metodegrunnlag eller annet grunnlagsmateriale NO EXCUSE AS benytter for å frembringe det endelige resultatet av Oppdraget beholdes av NO EXCUSE AS.
{% endcapture %}
{% include avtale-section.html heading="§3 Rettigheter" illustration="/assets/images/banners/avtale-t4-paragraf-3.webp" body=s3 %}
...
{% endcapture %}
{% include avtale-section.html heading="§4 Taushetsplikt og sikkerhet" illustration="/assets/images/banners/avtale-t4-paragraf-4.webp" body=s4 %}
...
{% endcapture %}
{% include avtale-section.html heading="§5 Mislighold og force majeur" illustration="/assets/images/banners/avtale-t4-paragraf-5.webp" body=s5 %}

{% capture s6 %}
§6.1 Norsk rett gjelder for Avtalen og dens inngåelse. Kundens verneting vedtas som verneting.

§6.2 Dersom det oppstår tvist om tolkningen eller rettsvirkningen av avtalen, skal tvisten først søkes løst ved forhandlinger. Fører forhandlingene ikke fram innen 21 virkedager, skal saken avgjøres ved dom, med mindre partene enes om å bringe saken til avgjørelse ved voldgift.

§6.3 Tvister mellom partene fritar i seg selv ikke partene fra å oppfylle sine forpliktelser.
{% endcapture %}
{% include avtale-section.html heading="§6 Tvister og verneting" illustration="/assets/images/banners/avtale-t4-paragraf-6.webp" body=s6 %}

{% endcapture %}
{% include avtale-page.html body=body %}
