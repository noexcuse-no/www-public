...
<section class="frame-hero">
    <div class="frame-hero-image">
        <img src="{{ '/assets/images/banners/banner-tillit.png' | relative_url }}" alt="Tillit i ledelse">
    </div>
...
<section class="frame-section">
    ...
    <ul class="frame-questions">
        <li>Hvor ofte gir du feedback som folk faktisk husker — og bruker?</li>
        <li>Hva ville skjedd hvis en medarbeider kom til deg med en dårlig nyhet i dag?</li>
        <li>Når ble siste gang du omgjorde en beslutning uten å forklare hvorfor?</li>
        <li>Finnes det informasjon du har som du bevisst holder tilbake fra teamet?</li>
        <li>Hvordan håndterer du folk som sier ifra mot strømmen?</li>
    </ul>
</section>
