...
Bolman & Deals fire perspektiver på ledelse — struktur, mennesker, påvirkning og identitet — utgjør rammeverket for alt vi gjør. Hvert perspektiv adresserer en grunnleggende dimensjon av GRC. [Forstå de fire perspektivene →](/perspektiv/)

![Fire perspektiver på ledelse og deres tilhørende GRC-dimensjoner](/assets/images/banners/grc-t2-four-perspectives-grc.webp)
...
![Abstrakt illustrasjon av informasjonssikkerhet og cyberresiliens](/assets/images/banners/grc-t3-informasjonssikkerhet.webp)

Les også: [Usikkerhetshåndtering henger tett sammen med informasjonssikkerhet →](/usikkerhet/)
...
![Abstrakt illustrasjon av miljø, helse og samfunnsansvar](/assets/images/banners/grc-t3-miljo.webp)

Her er identitetsperspektivet avgjørende. Les mer: [Identitetsperspektivet og verdibasert styring →](/perspektiv/)
