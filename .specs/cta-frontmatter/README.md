...
## Migration inventory (Completed 2026-08)
...
7. `_pages/kvalitet.md`
8. `_pages/ledelse_forankring.md`
10. `_pages/ledelse_generativ-ki.md`
11. `_pages/ledelse_makt.md`
12. `_pages/ledelse_perspektiv.md`
13. `_pages/ledelse_tillit.md`
14. `_pages/ledelse_triader.md`
15. `_pages/ledelse_usikkerhet.md`
16. `_pages/risikostyring.md`
17. `_pages/ledelse_60-2.md` — also needs `cta_a/b/c` → `cta` list
