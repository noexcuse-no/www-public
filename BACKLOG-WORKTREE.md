...
> **Project-wide BACKLOG:** See `/BACKLOG.md` at repo root for full project backlog (~120 items).
> This worktree backlog covers only the RI1 risk-reduction cleanup plan (T12-T23).
...
| C1 | **Customer case intake & planning** — Identify 1–3 real customer cases, conduct interviews, and obtain sign-off before publishing them on the site. | Doing | — |
