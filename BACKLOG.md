...
| G4 | **Conversion infrastructure (F4)** — email capture (F4a), step page enrichment (F4c, done via R25), article recommendations (F4d, future). All via approved external service — no repo storage. See `.specs/conversion-infrastructure/README.md`. | Doing | G1, G2, G3 (all contribute to the funnel) |
