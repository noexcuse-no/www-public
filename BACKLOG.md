...
| I2 | **Technical debt cleanup** — 5 phases: (1) Delete 16 orphaned includes + 3 dead CSS files — Done (PR #154). (4) Update `_config.yml` — remove empty `cases:`/`partners:` collections — Done (PR #155). Remaining: (2) Wire `.back-to-top` JS, (3) Extract mixed concerns from CSS, (5) Update documentation. See `.specs/technical-debt/README.md` and `.design/codebase-integrity.md`. | Doing | I1 |
...
| R29 | **Perspektiv & Makt section illustrations** — Generate T3 section illustrations for 14 Perspektiv sections and 2 Makt sections. Plus T4 card images for Perspektiv "Hva multiframe thinking faktisk er" cards. See `.specs/perspektiv-makt-illustrations/README.md`. | Doing | F7 |
