...
| P6 | **Partner presentation design & guidelines** — All 5 decisions recorded in `.specs/partners/README.md`. Partner guidelines document ready, covering product pitch, partner deliverables, redirect mechanism, commercial terms, and legal requirements. Frontmatter schema expanded for Full depth (description, services, industries, methodology, partner_type, funnel_roles). | Done | — |
