...
| `banners/informasjonssikkerhet-t1-hero.webp` | "Three abstract human silhouettes seen from behind on a nordic mountain ridge at dawn, bright white/light gray background — one figure extends a hand toward a translucent hexagonal shield with a soft azure glow protecting a stream of flowing data (information security), one figure rests a hand on a floating holographic network diagram with pulsing nodes (threat monitoring), one figure stands with digital-thread motifs rising like electricity through their hands toward the sky (cyberresilience) — cool Nordic color palette with azure (#F0FFFF) accent in the light, minimalist Nordic style, flat vector illustration, 16:9, no text, no faces visible" |
| NOTE: Perspektiv and GRC images were regenerated 2026-06-08 — migrated from Style 2 (abstract geometric) to Style 1. Informasjonssikkerhet replaced 2026-06-12 — previous version had Viking/Norse motifs, replaced with cyber-themed Style 1. All use "flat vector illustration" + "minimalist Nordic style" for consistent vector aesthetic. |
...
### Perspektiv & Makt Section Illustrations (Style 3 — R29)

**Use for:** Inline section illustrations for Perspektiv and Makt articles.

**Documented prompts — Perspektiv (14 images):**

| File | Prompt |
|------|--------|
| `banners/perspektiv-t3-samtidighet.webp` | "Clean minimal infographic showing multiframe simultaneity — a jazz musician holding melody, harmony, rhythm and interplay in their mind at once, four overlapping transparent colored lens shapes arranged in a diamond pattern, Scandinavian design style, azure blue and navy blue color palette, modern corporate illustration, no text" |
| `banners/perspektiv-t3-diagnostisk-disiplin.webp` | "Clean minimal infographic showing diagnostic discipline in leadership — a doctor's stethoscope transforming into a compass with four directions, four colored lenses (navy, golden, green, wine) arranged around a central question mark, systematic analysis, Scandinavian design style, azure blue and neutral gray color palette, modern corporate illustration, no text" |
| `banners/perspektiv-t3-praktisk-multiframe.webp` | "Clean minimal infographic showing practical multiframe thinking in action — two abstract figures in conversation, one holding up a hand to pause while four colored thought bubbles (navy, golden, green, wine) appear above showing different perspectives on the same problem, Scandinavian design style, azure blue and neutral gray color palette, modern corporate illustration, no text" |
| `banners/perspektiv-t3-hubbard.webp` | "Clean minimal infographic showing John Hubbard's influence on measurement methodology — a magnifying glass reducing uncertainty, a question mark transforming into a clear number, a scale weighing the unknown against the known, Scandinavian design style, azure blue and navy blue color palette, modern corporate illustration, no text" |
| `banners/perspektiv-t3-logan.webp` | "Clean minimal infographic showing David Logan's tribal culture stages — five ascending stages from stage two (dark isolated figure) through stage three (lone warrior) to stage four (tribal collaboration) and stage five (global impact), ascending staircase with language patterns emerging from each level, Scandinavian design style, deep wine and white color palette, modern corporate illustration, no text" |
| `banners/perspektiv-t3-pfeffer.webp` | "Clean minimal infographic showing Jeffrey Pfeffer's power dynamics in organizations — a network of connected nodes with some larger than others, arrows flowing in different directions suggesting influence and coalition-building, a central figure radiating authority, Scandinavian design style, hunter green and white color palette, modern corporate illustration, no text" |
| `banners/perspektiv-t3-multi-dimensionalitet.webp` | "Clean minimal infographic showing multi-dimensionality in organizations — a single number on a pedestal cracking and fracturing into multiple dimensions, a cube with different colored faces representing different aspects of organizational reality, complexity that cannot be reduced to one score, Scandinavian design style, azure blue and navy blue color palette, modern corporate illustration, no text" |
| `banners/perspektiv-t3-omorganisering.webp` | "Clean minimal infographic showing organizational restructuring — a complex org chart being simplified and reorganized, arrows showing new reporting lines, old rigid grid transforming into a more dynamic structure, Scandinavian design style, navy blue and white color palette, modern corporate illustration, no text" |
| `banners/perspektiv-t3-fusjon.webp` | "Clean minimal infographic showing company merger — two separate organizational shapes flowing together into one unified structure, arrows showing integration, two puzzle pieces connecting with a bridge between them, Scandinavian design style, navy blue and golden yellow color palette, modern corporate illustration, no text" |
| `banners/perspektiv-t3-krise.webp` | "Clean minimal infographic showing organizational crisis — a leader receiving urgent information, clock showing 48-hour countdown, multiple demands arriving simultaneously from all directions, a calm center in the storm, balanced decision-making under pressure, Scandinavian design style, warm gray and azure blue color palette, modern corporate illustration, no text" |
| `banners/perspektiv-t3-eksplisitt-reframing.webp` | "Clean minimal infographic showing explicit multiframe practice in meetings — a group around a table, one person raising a hand with four colored lenses (navy, golden, green, wine) held up, a pause button symbol suggesting stopping to reframe, Scandinavian design style, azure blue and neutral gray color palette, modern corporate illustration, no text" |
| `banners/perspektiv-t3-rullerende-perspektivskifte.webp` | "Clean minimal infographic showing rolling perspective shifts in a leadership team — a circular rotation pattern where four colored lenses (navy, golden, green, wine) rotate through a central focus point, each person in a team assigned a different perspective in rotation, dynamic shift of viewpoints, Scandinavian design style, azure blue and neutral gray color palette, modern corporate illustration, no text" |
| `banners/perspektiv-t3-tverrfaglig-integrasjon.webp` | "Clean minimal infographic showing interdisciplinary reading and cross-disciplinary learning — open books from different fields connected by flowing lines, an engineering book on power dynamics, an HR book on structure, a marketing book on psychology, knowledge flowing across boundaries, Scandinavian design style, azure blue and golden yellow color palette, modern corporate illustration, no text" |
| `banners/perspektiv-t3-ledelse-60-2-som-multiframe-praksis.webp` | "Clean minimal infographic showing Ledelse 60:2 as multiframe practice — a structured interview represented as a journey through four colored perspective lenses (navy, golden, green, wine) with 60 questions flowing through them, a clock showing 2 hours, a leader's thought process shifting perspectives with each question, Scandinavian design style, azure blue and navy blue color palette, modern corporate illustration, no text" |

**Documented prompts — Makt (2 images):**

| File | Prompt |
|------|--------|
| `banners/makt-t3-prisen.webp` | "Clean minimal infographic showing the price of power in organizations — a leader surrounded by shadows, a clock showing time wasted on politics, a broken connection line, a crown weighing heavily on a figure, Scandinavian design style, navy blue and white color palette, modern corporate illustration, no text" |
| `banners/makt-t3-spekteret.webp` | "Clean minimal infographic showing a spectrum from extraction to balance in leadership cultures — a horizontal gradient from dark, jagged shapes on left (power extraction) transitioning through balanced midpoint to open, welcoming organic forms on right (service), balanced scales at center, Scandinavian design style, navy blue and azure blue color palette, modern corporate illustration, no text" |
...
The image provenance metadata is part of a six-layer AI content disclosure system:

| Layer | File | Scope |
|-------|------|-------|
| JSON-LD @graph (per-page + per-image) | `_includes/provenance-jsonld.html` | Per-page `digitalSourceType` + per-image `ImageObject` entries for AI-generated images in `<head>`; non-AI images excluded via `_data/image-provenance.yml` exclude-list |
| Image IPTC/XMP bytes | `scripts/apply-provenance.sh` | IPTC/XMP on every WebP image file, skipping non-AI images in the exclude-list |
| Transparency manifest | `/.well-known/ai-transparency.json` | All site routes with tool attribution + editorial review status + regulatory contact |
| EU basic icon visible disclosure | `_includes/header.html` + `_includes/eu-ai-icon.html` | EU AI Act basic icon beside the banner text, linking to the editorial-responsibility page. Banner only — NO image badges |
...
| Per-image machine-readable RDFa | `assets/scripts/ai-provenance-injector.js` | Runtime RDFa injection of `schema:digitalSourceType` on content `<img>` elements (build-time + runtime; no visible badges) |
