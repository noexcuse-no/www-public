...
| `banners/grc-t1-hero.webp` | "Professional abstract illustration for GRC governance leadership banner, clean minimal Scandinavian style, showing four overlapping transparent geometric lenses converging toward a central target point, structured and balanced composition, azure blue and navy blue color palette, clean white background, symbolic imagery only, no text, high resolution" |
