...
| `banners/hero-perspektiv.webp` | "Three abstract human silhouettes seen from behind standing on a hilltop in a Nordic landscape, looking at a view that splits into four distinct colored zones through four transparent overlapping lens-like frames, bright white cloud-studded sky, cool Nordic color palette with azure (#F0FFFF) accent in the light, minimalist Nordic style, 16:9 aspect ratio, high resolution 4K, no text, no faces visible" |
| `banners/grc-t1-hero.webp` | "Three abstract human silhouettes seen from behind standing at a structured junction in a Nordic landscape, protective geometric shield elements around them, multiple clear paths converging toward a central point suggesting coordinated governance and risk management, bright white cloud-studded sky, cool Nordic color palette with azure (#F0FFFF) accent in the light, minimalist Nordic style, 16:9 aspect ratio, high resolution 4K, no text, no faces visible" |
| NOTE: The two entries above were migrated from Style 2 to Style 1 on 2026-06-08 to unify the hero visual language across all main pages. |
