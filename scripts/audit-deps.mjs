...
function checkSlopsquat(pkgNames) {
  ...
  for (const name of pkgNames) {
    ...
    const lower = name.toLowerCase();
    if (knownBrands.includes(lower)) continue;
